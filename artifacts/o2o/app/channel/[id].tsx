  ...
  return (
    <KeyboardAvoidingView style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        {!isOwner && (
          <TouchableOpacity
            style={[styles.followBtn, { backgroundColor: isFollowing ? colors.muted : colors.primary }]}
      ...
      {!isOwner && tab === "posts" && (
        <View style={[styles.readOnly, { backgroundColor: colors.muted, borderTopColor: colors.border }] }>
          ...
          <Text style={[styles.readOnlyText, { color: colors.mutedForeground }]}>Only admins can post</Text>
        </View>
      )}
    </KeyboardAvoidingView>
  );
